...
class Pool(pools.Pool):
    ...
    def empty(self):
        ...
        if self.connection_cls.pool is not None:
            if self.connection_cls.pool.reply_proxy is not None:
                self.connection_cls.pool.reply_proxy.close()
                self.connection_cls.pool.reply_proxy = None
