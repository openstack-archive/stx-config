...
class DataNetworkTypeNotFound(NotFound):
    message = _("DataNetwork of type %(datanetwork_type)s could not be found.")
...
class DataNetworkTypeUnsupported(Conflict):
    message = _("DataNetwork of type %(datanetwork_type)s is not supported.")
...
class UnsupportedAssignedInterfaceDataNetworkType(Conflict):
    message = _("Cannot assign datanetwork with type '%(datanetwork_type)s' "
                "to an interface.")


class UnsupportedRemovedInterfaceDataNetworkType(Conflict):
    message = _("Cannot remove datanetwork with type '%(datanetwork_type)s' "
                "from an interface.")
