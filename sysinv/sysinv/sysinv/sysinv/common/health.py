...
class Health(object):
    ...
    def _check_alarms(self, force=False, context=None):
    ...
    def get_system_health(self, force=False, context=None):
        ...
        success, allowed, affecting = self._check_alarms(force, context)
    ...
    def get_system_health_upgrade(self, force=False, context=None):
        ...
        health_ok, output = self.get_system_health(force, context)
