...
class AppOperator(object):
    ...
    def _update_image_overrides_by_charts(self, app_path, charts):
    ...
    def _save_images_list(self, app):
        ...
        if app.system_app:
            ...
            images_to_download = self._update_image_overrides_by_charts(
    ...
    def _download_images(self, app, updated_images_list=None):
        ...
        if app.system_app:
            ...
            combined_images_list.extend(updated_images_list)
        ...
        try:
            ...
            if app.system_app:
                ...
                if overrides_files:
                    ...
                    self._download_images(app, images_to_download)
                else:
                    ready = False
            else:
