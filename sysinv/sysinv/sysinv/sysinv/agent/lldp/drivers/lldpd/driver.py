...
class SysinvLldpdAgentDriver(base.SysinvLldpDriverBase):
    ...
    @staticmethod
    def _lldpd_get_agent_status(self):
        json_obj = json
    ...
    @staticmethod
    def _lldpd_get_attrs(self, iface):
        name_or_uuid = None
        chassis_id = None
        system_name = None
        system_desc = None
    ...
    def lldp_agents_list(self):
        ...
        for iface in lldp['interface']:
            agent_attrs = self._lldpd_get_attrs(self, iface)
            status = self._lldpd_get_agent_status(self)
    ...
    def lldp_neighbours_list(self):
        ...
        for iface in lldp['interface']:
            neighbour_attrs = self._lldpd_get_attrs(self, iface)
