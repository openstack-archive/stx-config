...
def _print_datanetwork_show(obj):
    fields = ['id', 'uuid', 'name', 'datanetwork_type', 'mtu',
              'description']

    if obj.datanetwork_type == DATANETWORK_TYPE_VXLAN:
...
def do_datanetwork_list(cc, args):
    ...
    labels = ['uuid', 'name', 'datanetwork_type', 'mtu']
    fields = ['uuid', 'name', 'datanetwork_type', 'mtu']
...
@utils.arg('datanetwork_type',
           metavar='<datanetwork_type>',
...
def do_datanetwork_add(cc, args):
    ...
    field_list = ['name', 'datanetwork_type', 'mtu', 'description',
