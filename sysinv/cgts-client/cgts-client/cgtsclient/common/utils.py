...
# Convert size from a smaller unit (e.g. KiB) to a larger
# unit (e.g. GiB). Each 1024 is 1 step. e.g. From BYTE to
# MiB is 2 steps. From MiB to GiB is 1 step. The return value
# is a float with 3 digits after the decimal point.
