...
class ConfigValidator(object):
    ...
    def validate_region(self, config_type=REGION_CONFIG):
        ...
        barbican_user_name = self.conf.get('REGION_2_SERVICES', 'BARBICAN_USER_NAME')
        ...
        if self.cgcs_conf is not None:
            ...
            self.cgcs_conf.set('cREGION', 'BARBICAN_USER_NAME', barbican_user_name)
            self.cgcs_conf.set('cREGION', 'BARBICAN_PASSWORD', barbican_password)
