        ...
        try:
            ...
            if self.kubernetes:
                if config.has_section('cCLUSTER'):
                    if config.has_option('cCLUSTER', 'CLUSTER_INTERFACE_NAME'):
                        self.cluster_host_interface_name = config.get(
                            'cCLUSTER', 'CLUSTER_INTERFACE_NAME')
                    if config.has_option('cCLUSTER', 'CLUSTER_INTERFACE'):
                        self.cluster_host_interface = config.get(
                            'cCLUSTER', 'CLUSTER_INTERFACE')
                    if config.has_option('cCLUSTER', 'CLUSTER_MTU'):
                    ...
                    if config.has_option('cCLUSTER', 'CLUSTER_SUBNET'):
