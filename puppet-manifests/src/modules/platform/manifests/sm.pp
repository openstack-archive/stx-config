...
class platform::sm
  ...
  if $kubernetes_enabled {
    ...
    include ::platform::network::cluster::params
    $infra_ip_interface          = $::platform::network::cluster::params::interface_name
  } else {
  ...
  if $infra_ip_interface {
    if $kubernetes_enabled {
      # Repurposing the infra interface for cluster-host interface
      $cgcs_nfs_ip_interface   = $::platform::network::cluster::params::interface_name
      $cgcs_nfs_ip_param_ip    = $::platform::network::cluster::params::cgcs_nfs_address
      $cgcs_nfs_ip_network_url = $::platform::network::cluster::params::subnet_network_url
      $cgcs_nfs_ip_param_mask  = $::platform::network::cluster::params::subnet_prefixlen

      $cinder_ip_interface     = $::platform::network::cluster::params::interface_name
      $cinder_ip_param_mask    = $::platform::network::cluster::params::subnet_prefixlen
    } else {
  ...
  if $system_mode == 'simplex' {
    ...
    if $kubernetes_enabled {
      # Repurposing the infra interface for cluster-host interface
      $infra_my_unit_ip = $::platform::network::cluster::params::controller_address
    }
  } else {
    case $::hostname {
      $controller_0_hostname: {
        ...
        if $kubernetes_enabled {
          # Repurposing the infra interface for cluster-host interface
          $infra_my_unit_ip = $::platform::network::cluster::params::controller0_address
          $infra_peer_unit_ip = $::platform::network::cluster::params::controller1_address
        } else {
      ...
      $controller_1_hostname: {
        ...
        if $kubernetes_enabled {
          # Repurposing the infra interface for cluster-host interface
          $infra_my_unit_ip = $::platform::network::cluster::params::controller1_address
          $infra_peer_unit_ip = $::platform::network::cluster::params::controller0_address
        } else {
