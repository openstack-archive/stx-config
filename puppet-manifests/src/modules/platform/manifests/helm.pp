    ...
    if (str2bool($::is_initial_config) and $::personality == 'controller') {
      ...
      if str2bool($::is_initial_config_primary) {
        ...
        -> exec { 'initialize helm':
          ...
          command     => "helm init --skip-refresh --service-account tiller --node-selectors \"node-role.kubernetes.io/master\"=\"\" --tiller-image=${gcr_registry}/kubernetes-helm/tiller@sha256:022ce9d4a99603be1d30a4ca96a7fa57a45e6f2ef11172f4333c18aaae407f5b", # lint:ignore:140chars
          logoutput   => true,
          user        => 'wrsroot',
          group       => 'wrs',
